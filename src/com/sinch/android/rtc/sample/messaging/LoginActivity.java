...
public class LoginActivity extends BaseActivity implements SinchService.StartFailedListener {
    ...
    @Override
    protected void onCreate(Bundle savedInstanceState) {   //如果運用在parse整合上，那就必須要在app login時就必須要登入sinch
        super.onCreate(savedInstanceState);                 //need  BaseActivity LoginActivity SinchService
